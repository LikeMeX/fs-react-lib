...
const AssistantPanel = ({ surface = 'general', courseId = null, lessonId, chapterId, lessonComplete = false, courseComplete = false, modes, userMember, canUse, collectLearnerProfile: collectLearnerProfileProp, showLearnerProfile, getVideoTimestamp, learningPathId, learningPathName, additionalContext, suggestedActions: pinnedSuggestedActions, }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("aside", { "aria-hidden": !open ? 'true' : 'false', style: panelWidthStyle !== undefined && open
                    ...
                    : !open && compactViewport
                        ? { width: 0, maxWidth: 0 }
                        : undefined, className: `fixed z-40 flex flex-col border-l border-blackFS-500 bg-blackFS-800 shadow-2xl transition-[transform,width] duration-300 ease-out ${overlayLayout ? 'inset-0 max-w-none' : 'inset-y-0 right-0 max-w-[100vw]'} ${open ? 'translate-x-0' : 'translate-x-full'} ${!open && compactViewport ? 'pointer-events-none overflow-hidden border-0 p-0' : ''}`, children: (0, jsx_runtime_1.jsxs)("div", { className: "flex h-full min-h-0 flex-col p-4", children: [(0, jsx_runtime_1.jsxs)("header", { className: "mb-3 flex shrink-0 items-center gap-1 border-b border-blackFS-600 pb-3", children: [(0, jsx_runtime_1.jsx)(antd_1.Tooltip, { title: "\u0E1A\u0E17\u0E2A\u0E19\u0E17\u0E19\u0E32\u0E01\u0E48\u0E2D\u0E19\u0E2B\u0E19\u0E49\u0E32", children: (0, jsx_runtime_1.jsx)("button", { type: "button", "aria-label": "\u0E40\u0E25\u0E37\u0E2D\u0E01\u0E1A\u0E17\u0E2A\u0E19\u0E17\u0E19\u0E32\u0E01\u0E48\u0E2D\u0E19\u0E2B\u0E19\u0E49\u0E32", onClick: openHistory, className: "flex h-10 w-10 shrink-0 items-center justify-center rounded-lg text-white/90 transition hover:bg-white/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primaryFS-400", children: (0, jsx_runtime_1.jsx)(LuHistory, { size: 20, "aria-hidden": true }) }) }), (0, jsx_runtime_1.jsx)("h2", { className: "min-w-0 flex-1 truncate text-center text-sm font-semibold text-white", children: "\u0E1C\u0E39\u0E49\u0E0A\u0E48\u0E27\u0E22\u0E01\u0E32\u0E23\u0E40\u0E23\u0E35\u0E22\u0E19" }), (0, jsx_runtime_1.jsx)(antd_1.Tooltip, { title: "\u0E2A\u0E19\u0E17\u0E19\u0E32\u0E43\u0E2B\u0E21\u0E48", children: (0, jsx_runtime_1.jsx)("button", { type: "button", "aria-label": "\u0E40\u0E23\u0E34\u0E48\u0E21\u0E1A\u0E17\u0E2A\u0E19\u0E17\u0E19\u0E32\u0E43\u0E2B\u0E21\u0E48", onClick: handleNewConversation, className: "flex h-10 w-10 shrink-0 items-center justify-center rounded-lg text-white/90 transition hover:bg-white/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primaryFS-400", children: (0, jsx_runtime_1.jsx)(LuMessageSquarePlus, { size: 20, "aria-hidden": true }) }) }), showProfileControl && ((0, jsx_runtime_1.jsx)(antd_1.Tooltip, { title: profileEditOpen ? 'กลับไปสนทนา' : 'แก้ไขโปรไฟล์ผู้เรียน', children: (0, jsx_runtime_1.jsx)("button", { type: "button", "aria-label": profileEditOpen ? 'กลับไปสนทนา' : 'แก้ไขโปรไฟล์ผู้เรียน', onClick: profileEditOpen ? cancelProfileEdit : openProfileMenu, className: "flex h-10 w-10 shrink-0 items-center justify-center rounded-lg text-white/90 transition hover:bg-white/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primaryFS-400", children: (0, jsx_runtime_1.jsx)(LuUserCog, { size: 20, "aria-hidden": true }) }) })), (0, jsx_runtime_1.jsx)(antd_1.Tooltip, { title: fullPage ? 'โหมดแผงข้าง' : 'โหมดเต็มหน้าจอ', children: (0, jsx_runtime_1.jsx)("button", { type: "button", "aria-label": fullPage ? 'ย่อแผงผู้ช่วย' : 'ขยายแผงผู้ช่วยเต็มหน้าจอ', onClick: toggleFullPage, className: `flex h-10 w-10 shrink-0 items-center justify-center rounded-lg text-white/90 transition hover:bg-white/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primaryFS-400 ${compactViewport ? 'hidden' : ''}`, children: fullPage ? (0, jsx_runtime_1.jsx)(LuMinimize2, { size: 20, "aria-hidden": true }) : (0, jsx_runtime_1.jsx)(LuMaximize2, { size: 20, "aria-hidden": true }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Tooltip, { title: "\u0E1B\u0E34\u0E14\u0E1C\u0E39\u0E49\u0E0A\u0E48\u0E27\u0E22", children: (0, jsx_runtime_1.jsx)("button", { type: "button", "aria-label": "\u0E1B\u0E34\u0E14\u0E1C\u0E39\u0E49\u0E0A\u0E48\u0E27\u0E22\u0E01\u0E32\u0E23\u0E40\u0E23\u0E35\u0E22\u0E19", onClick: () => setOpen(false), className: "flex h-10 w-10 shrink-0 items-center justify-center rounded-lg text-white/90 transition hover:bg-white/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primaryFS-400", children: (0, jsx_runtime_1.jsx)(LuX, { size: 20, "aria-hidden": true }) }) })] }), lastError === 'FORBIDDEN' && ((0, jsx_runtime_1.jsx)(antd_1.Alert, { type: "error", message: "\u0E44\u0E21\u0E48\u0E21\u0E35\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E4C\u0E43\u0E0A\u0E49\u0E07\u0E32\u0E19\u0E1C\u0E39\u0E49\u0E0A\u0E48\u0E27\u0E22", className: "mb-3", showIcon: true })), convQuery.isError && ((0, jsx_runtime_1.jsx)(antd_1.Alert, { type: "error", message: "\u0E44\u0E21\u0E48\u0E2A\u0E32\u0E21\u0E32\u0E23\u0E16\u0E2A\u0E23\u0E49\u0E32\u0E07\u0E1A\u0E17\u0E2A\u0E19\u0E17\u0E19\u0E32\u0E44\u0E14\u0E49", className: "mb-3", showIcon: true })), streamError && ((0, jsx_runtime_1.jsx)(antd_1.Alert, { type: "error", message: streamError, className: "mb-3", showIcon: true, closable: true })), historyError && ((0, jsx_runtime_1.jsx)(antd_1.Alert, { type: "warning", message: historyError, className: "mb-3", showIcon: true, closable: true, onClose: () => setHistoryError(null) })), ensureError && ((0, jsx_runtime_1.jsx)(antd_1.Alert, { type: "error", message: ensureError, className: "mb-3", showIcon: true, closable: true, onClose: () => setEnsureError(null) })), (0, jsx_runtime_1.jsx)("div", { className: `flex min-h-0 flex-1 flex-col ${inSkillpassOnboarding || inProfileChat ? 'overflow-hidden' : 'overflow-y-auto'}`, children: inSkillpassOnboarding && fsAiUserId ? ((0, jsx_runtime_1.jsx)(OnboardingWizard_1.OnboardingWizard, { fsAiUserId: fsAiUserId, restart: profileEditOpen && (onboardingComplete || hasSavedProfile), onComplete: handleOnboardingComplete })) : inProfileChat ? ((0, jsx_runtime_1.jsx)("div", { className: "flex min-h-0 flex-1 flex-col overflow-hidden", children: (0, jsx_runtime_1.jsx)(MessageList_1.MessageList, { messages: profileChatMessages }) })) : showPicker ? ((0, jsx_runtime_1.jsx)(ModePicker_1.ModePicker, { disabled: !chatInputReady, modes: allowedModes, onSelect: mode => setSelectedMode(mode) })) : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [messages.length === 0 ? ((0, jsx_runtime_1.jsx)(WelcomeMessage_1.WelcomeMessage, { mode: apiMode })) : ((0, jsx_runtime_1.jsx)(MessageList_1.MessageList, { messages: messages })), (0, jsx_runtime_1.jsx)(SuggestedActions_1.SuggestedActions, { mode: apiMode, actions: suggestedActions, pinned: pinnedSuggestedActions, disabled: streaming || !chatInputReady || isCreatingConversation, onSelect: (message, actionIntent) => {
