...
const MessageBubble = ({ message }) => {
    ...
    return (react_1.default.createElement("div", { className: `max-w-[85%] rounded-2xl px-3.5 py-2.5 text-sm leading-relaxed ${isUser ? 'ml-auto rounded-br-sm bg-primaryFS-500 text-white' : 'mr-auto rounded-bl-sm bg-blackFS-600 text-blackFS-100'}` },
        isUser ? (react_1.default.createElement("div", { className: "whitespace-pre-wrap" }, message.content)) : isWaiting ? (react_1.default.createElement(TypingIndicator_1.TypingIndicator, null)) : (react_1.default.createElement(react_markdown_1.default, { remarkPlugins: [remark_gfm_1.default, remark_math_1.default, pruneEmptyListItems], rehypePlugins: [rehype_katex_1.default], components: markdownComponents }, (0, sanitizeAssistantMarkdown_1.sanitizeAssistantMarkdown)(message.content))),
